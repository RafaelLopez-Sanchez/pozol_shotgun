...
$ python3.7 /home/install/KrakenTools/combine_mpa.py -i ~/pozol/taxonomy/0hrs/bacteria.report ~/pozol/taxonomy/9hrs/bacteria.report ~/pozol/taxonomy/24hrs/bacteria.report ~/pozol/taxonomy/48hrs/bacteria.report -o combine.report
...
9.Get percentage abundance with local script. 
